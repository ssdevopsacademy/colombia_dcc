...
- D: Bitbucket, GitLab, Github, Git :heavy_check_mark:<br>

### 3. What is the versioning strategy / workflow that only has one main branch
- A. Git-Flow
- B. feature Branches
- C. Trunk-based development :heavy_check_mark:

### 4. the difference between "Commit" and "Add" commands is:
- A. "Commit"" save all staged changes and "Add" includes a change in the working directory :heavy_check_mark:
...
- C. git clone /path/to/repository :heavy_check_mark:
- D. github clone /path/to/repository 

### 6. Add one or more files to staging (index) to Github:
- A. github add *
- B. git * add * 
- C. git add * :heavy_check_mark:
- D. git push add * 
...
- D. git push origin master :heavy_check_mark:

### 8. In SCRUM, usually the User Stories are translated to the Technical Team as:
- A. Features branches
- B. Hot Fixes and Bug Fixes Branches
- C. Master Branches
- D. A & B :heavy_check_mark:

### 9. Merge conflicts are:
- A. Normal events that occurs when Git is unable to automatically resolve differences in code between two commits.:heavy_check_mark:
- B. Code build Errors
...
- B. Gitflow and Trunk-based development :heavy_check_mark:
