...
- C: Mercurial, Monotone, Apache Subversion, Bazaar, CVS **-->Correct** <br>
...
- B. "Add" save all staged changes and "Commit" includes a change in the working directory **-->Correct**
...
- C. git clone /path/to/repository  **-->Correct**
...
- D. git push origin master **-->Correct**

### 8. In SCRUM, usually the User Stories are translated to the Technical Team as:
- A. Features branches **-->Correct**
...
- B. Gitflow and Trunk-based development **-->Correct**
...
*My expectation from this course is to learn more about the DevOps world and to gain skills to be more competitive in my jobs. My mid-term goal is to work as an engineer with integral knowledge in the way that I can give support in many differents fronts of the IT and software development world, to achieve the strategic goals of the company.*
