...
- C. Git Master and Trunk-based development :o:
...
### Student SoftServe : Andres Guarin Salazar
I expect this course to teach me the basics needed to apply all the necessary tools (virtualization, monitoring, automation, networking, etc) into the development Cycle. Also, I expect to learn and understand the entirety of the CI/CD, so I can be able to help deliver continuous high quality software in shorts ammounts of time. 
